...
\item Type theory, static analysis, functional programming, formal verification, technical writing
...
\item \textbf{ShoreTel -- Embedded Software Engineer} (2016 - 2018)
  \begin{itemize}[label=$\circ$]
  \item Architected next-gen embedded C++ phone firmware, reducing race conditions by 100\%
