...
\begin{itemize}[label=$\circ$]
\item Expertise in Emacs/Common LISP, git, Ruby, C/C++, Python, Perl, BASH, asm, Java
\item Familiar with Octave, GNU Make, Haskell, HTML, Tcl, JavaScript, VHDL, System Verilog, documentation
\end{itemize}
...
\begin{paracol}{2}
  ...
  \item Founded competitive UIL comp-sci team (taught C++, Java, Perl)
  \end{itemize}
